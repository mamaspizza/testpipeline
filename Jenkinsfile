    ...
    try {
       stage('Test'){
           ...
           script{
            ...
            // Create DB
            def mapDB = [:]
            mapDB['PostgreSQL96'] = "docker.io/postgres:9.4"
            mapDB['PostgreSQL98'] = "docker.io/postgres:latest"
            mapDB['Oracle'] = "docker.io/oraclelinux:latest"
            mapDB['SQLServer'] = "mcr.microsoft.com/mssql/server:latest"
